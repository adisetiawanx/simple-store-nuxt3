            ...
            <section aria-labelledby="options-heading">
              <form @submit.prevent="addProductToCartHandler">
                <div class="mt-10">
                  <button
                    type="submit"
                    class="flex w-full items-center justify-center rounded-md border border-transparent bg-yellow-500 px-8 py-3 text-base font-medium text-white hover:bg-yellow-400 active:scale-105 transition-all"
                  >
                    Add to cart
                  </button>
                </div>
